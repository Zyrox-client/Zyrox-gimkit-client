// Injected by Zyrox Client MV3 extension.
// Runs in the page context at document_start so WebSocket hooks can install early.
if (window.__ZYROX_EXTENSION_INJECTED__) {
  // Prevent duplicate initialization from reinjection/navigation quirks.
} else {
  window.__ZYROX_EXTENSION_INJECTED__ = true;
    ...
    const preset = (() => {
      ...
      if (state.globalPreset === "midnight") {
        return {
          ...
          headerStart: "#9b5cff", headerEnd: "#220d40", headerText: "#ffffff",
