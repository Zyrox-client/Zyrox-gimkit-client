...
7. Use the top-bar ⚙ settings button to customize categorized options in a sidebar (controls, theme, and appearance), including module bar text/colors and subcategories like Main Window and Modules.
