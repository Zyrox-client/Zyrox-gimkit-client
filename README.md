...
7. Use the top-bar ⚙ settings button to customize categorized options in a sidebar (controls, theme, and appearance), including module bar text/colors with custom two-point gradients and subcategories like Main Window and Modules.
